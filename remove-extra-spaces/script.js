 ...
 * Trims whitespace and normalizes multiple spaces to single spaces.
 */
(function () {
    'use strict';
    ...
    var removeSpacesBtn = document.getElementById('remove-spaces-btn');
    ...
    function handleRemoveSpaces() {
        textOutput.value = removeExtraSpaces(textInput.value);
    }
